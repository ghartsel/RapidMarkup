...
Included files within a section are located in the /module/<section>/partials directory. Globally included files are located in the /modules/&#43;includes/partials directory.
