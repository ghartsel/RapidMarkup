...
See the following AsciiDoc table documentation for common table formatting options that are used in rendering tables in Fauna documentation:

- https://docs.asciidoctor.org/asciidoc/latest/tables/align-by-cell/[Align Content by Cell]https://docs.asciidoctor.org/asciidoc/latest/tables/format-cell-content/[Format Content by Cell]
